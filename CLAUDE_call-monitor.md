...
> 🚨 **完整護欄清單（目前 G1–G205）已於 2026-09-04 獨立成檔，2026-09-24 第五十三輪
> 再依前端／後端分成兩卷**：
> 索引 **[`CLAUDE_call-monitor-guardrails.md`](CLAUDE_call-monitor-guardrails.md)**
> ／前端卷 **[`CLAUDE_call-monitor-guardrails-frontend.md`](CLAUDE_call-monitor-guardrails-frontend.md)**（§7.1，111 條）
> ／後端卷 **[`CLAUDE_call-monitor-guardrails-backend.md`](CLAUDE_call-monitor-guardrails-backend.md)**（§7.2，94 條）
>
