          ...
          child: Column(
            children: [
              ...
              if (!isRoleSelected) ...[
                ...
                const SizedBox(height: 20),
                ElevatedButton(icon: null, label: const Text("我是監控設備"), style: ElevatedButton.styleFrom(backgroundColor: Colors.grey, minimumSize: const Size.fromHeight(60)), onPressed: () => setState(() => _selectedRole = 'monitor')),
                const SizedBox(height: 20),
