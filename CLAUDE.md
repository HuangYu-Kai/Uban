...
| **198 條護欄（絕對不可單點修改）** | `CLAUDE_call-monitor-guardrails.md`（原 §7，2026-09-04 起獨立成檔） |
| 這段程式碼為什麼長這樣（51 輪修復年表；近期輪次在 §8，第一至三十五輪在 `CLAUDE_call-monitor-history.md`） | §8 |
...
**完整規則見 [`CLAUDE_call-monitor-guardrails.md`](CLAUDE_call-monitor-guardrails.md)（198 條護欄）。**
...
通話與監控子系統的完整修復年表（2026-06-05 起，已累積 51 輪）已逐條核對，內容全數存在於
