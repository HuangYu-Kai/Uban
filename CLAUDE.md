...
| **118 條護欄（絕對不可單點修改）** | §7 |
| 這段程式碼為什麼長這樣（36 輪修復年表；近期輪次在 §8，第一至三十三輪在 `CLAUDE_call-monitor-history.md`） | §8 |
...
通話與監控子系統的完整修復年表（2026-06-05 起，已累積 36 輪）已逐條核對，內容全數存在於
[`CLAUDE_call-monitor.md`](CLAUDE_call-monitor.md) §8（近期輪次）與
[`CLAUDE_call-monitor-history.md`](CLAUDE_call-monitor-history.md)（第一至三十三輪，含本節原本
