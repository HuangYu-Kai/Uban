...
pytest tests/
pytest tests/test_call_signaling.py -q   # 通話迴歸套件，須維持 8 passed
...
**完整規則見 [`CLAUDE_call-monitor.md`](CLAUDE_call-monitor.md) §7（36 條護欄）。**
...
通話與監控子系統的完整修復年表（2026-06-05 起共 14 輪，含每一輪的根因、檔案、行號）
